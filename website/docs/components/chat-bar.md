...
![MdsChatBar — glassmorphism input bar with action buttons](/img/screenshots/components-demo.png)

*`MdsChatBar` with `Actions` slot — `+` button, Smart dropdown and audio icon.*
